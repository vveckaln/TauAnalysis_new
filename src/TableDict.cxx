...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Column_spec<float>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Column_spec<float>", ::Column_spec<float>::Class_Version(), "LIP/TauAnalysis/interface/Table.h", 28,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Column_spec<short>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Column_spec<short>", ::Column_spec<short>::Class_Version(), "LIP/TauAnalysis/interface/Table.h", 28,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Column_spec<double>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Column_spec<double>", ::Column_spec<double>::Class_Version(), "LIP/TauAnalysis/interface/Table.h", 28,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Column_spec<unsigned short>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Column_spec<unsigned short>", ::Column_spec<unsigned short>::Class_Version(), "LIP/TauAnalysis/interface/Table.h", 28,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Column_spec<const char*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Column_spec<const char*>", ::Column_spec<const char*>::Class_Version(), "LIP/TauAnalysis/interface/Table.h", 28,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Column_spec<TString>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Column_spec<TString>", ::Column_spec<TString>::Class_Version(), "LIP/TauAnalysis/interface/Table.h", 28,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Column*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Column", ::Column::Class_Version(), "LIP/TauAnalysis/interface/Table.h", 9,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Table*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Table", ::Table::Class_Version(), "LIP/TauAnalysis/interface/Table.h", 72,
...
"LIP/TauAnalysis/interface/Table.h",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("TableDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_TableDict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_TableDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_TableDict() {
  TriggerDictionaryInitialization_TableDict_Impl();
}
