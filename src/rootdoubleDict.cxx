...
#define R__DICTIONARY_FILENAME srcdIrootdoubleDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::rootdouble*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("rootdouble", ::rootdouble::Class_Version(), "interface/rootdouble.h", 5,
...
#include "interface/rootdouble.h"
